...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/Sidansaid089-hue/improved-giggle/blob/main/.github/images/submit-review-button.png?raw=true" />
